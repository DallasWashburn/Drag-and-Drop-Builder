...
import TestimonialsMenu from "../Testimonials-Menu/Testimonials-Menu"


class TestimonailsContainer extends Component {
...
render() {
    return (
        <div className="accordian" id="accordionTestimonial">
        <TestimonialsButton handleMouseDown={this.handleMouseDown}/>
        <TestimonialsMenu onArrow={this.props.onArrow}  handleMouseDown={this.handleMouseDown} />
        </div>
    )
}
}
export default TestimonailsContainer
