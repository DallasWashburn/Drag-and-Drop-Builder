...
class Contact0 extends Component {
    render() {
        return (
            <section className="contact_1 section__wrapper">
                <div className="container">
                    <div className="row flex-row-reverse">
                        <div className="col-md-6">
                            <div className="contact__iframe map-responsive">
                                <iframe title="map" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13284.447635013606!2d-112.1124225!3d33.6542621!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xefe25fe92d40af5f!2sCyberMark!5e0!3m2!1sen!2sus!4v1614899612265!5m2!1sen!2sus" width="600" height="450"  loading="lazy"></iframe>				</div>
                        </div>
                        <div className="col-md-6">
