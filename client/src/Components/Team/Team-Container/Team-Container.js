...
import TeamButton from "../Team-Button/Team-Button"
...
render() {
    return (
        <div className="accordian" id="accordionTeam">
        <TeamButton handleMouseDown={this.handleMouseDown}/>
        <TeamMenu onArrow={this.props.onArrow} handleMouseDown={this.handleMouseDown}/>
        </div>
    )
}
}
